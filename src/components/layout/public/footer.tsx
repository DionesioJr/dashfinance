          ...
          <div className="lg:col-span-2">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm mt-2 max-w-md">
                Plataforma profissional para planejadores, consultores e assessores financeiros. Gerencie múltiplos clientes,
                automatize processos e escale seu negócio com tecnologia de ponta.
              </p>
              ...
              <ul className="space-y-3">
                {section.links.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-gray-600 hover:text-green-600 dark:text-gray-400 dark:hover:text-green-500 transition-colors text-sm"
                    >
                      {link.name}
                    </Link>
                  </li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0 flex items-center gap-4">
              <Link
                ...
                className="flex items-center gap-1 text-sm font-medium text-gray-900 dark:text-white hover:text-green-600 dark:hover:text-green-500 transition-colors"
              >
